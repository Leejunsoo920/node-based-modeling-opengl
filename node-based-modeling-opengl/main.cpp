...
int main()
{
    ...
    scenectrl.set_shader("shader/UIshader.vs", "shader/shapematchingshader.fs", "UI shader_red");
    scenectrl.set_shader("shader/UIshader_blue.vs", "shader/UIshader_blue.fs", "UI shader_blue");
    ...
    scenectrl.set_shader("shader/shapematchingshader.vs", "shader/shapematchingshader.fs", "shapematching shader");
