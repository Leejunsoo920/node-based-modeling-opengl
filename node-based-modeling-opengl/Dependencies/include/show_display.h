...
public:
    ...
    void set_shader(const char* vertexPath, const char* fragmentPath, string name, const char* geometryPath = nullptr)
    {
...
public:
    ...
    Show_Display()
    {
        this->window = make_shared<Window>("my win", 1800, 1080);
        this->camera = make_shared<Camera>();
        this->nodemode = make_shared<Nodemode>(window, camera);
    }
