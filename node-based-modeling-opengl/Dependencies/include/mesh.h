...
public:
    ...
    // constructor
    Mesh(std::vector<Vertex> vertices, numbers_t indices, std::vector<Texture> textures)
    {
    ...
    void setup_Mesh(){setupMesh();}
    void update_Mesh(){update_now_Mesh();}
    // render the mesh
