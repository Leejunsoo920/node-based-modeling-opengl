...
public:
    ...
    void set_shader(const char* vertexPath, const char* fragmentPath, string name, const char* geometryPath = nullptr){operation.set_shader(vertexPath, fragmentPath,name,geometryPath);}
